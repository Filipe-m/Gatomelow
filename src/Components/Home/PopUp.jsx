    ...
    <React.Fragment>
      {open && (
        ...
        <div className='h-full w-full flex items-center justify-between text-center opacity-100 flex-col'>
          <h1 className='p-3'>Este site é uma paródia de <a className='underline text-main-color font-bold ' href="https://www.usecaramelow.com.br/">Caramelow™</a> , sendo a mesma detentora de todos os direitos de imagens e produtos utilizados.</h1>
